    ...
    <div class="col-10 offset-1 d-none d-md-block" style="font-size:14px;">
      <div class="bd-example" data-example-id="">
          <div id="carouselBlock" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner" role="listbox" style="padding:40px; height:280px;">                 
            <?php 
            $o = 0;
            foreach((array)$developers as $developer){?>
              <div class="carousel-item <? if($o==0){?>active<? }?>">
                <div class="row">
                    ...
                    <div class="col-12 col-md-3" style="background-position: center; background-repeat: no-repeat; background-size: contain; height: 200px; background-image:url('<?php echo $n['developer_photo']?>')">
                    </div>	
                    <?php }?>
                </div>                     
              </div>
