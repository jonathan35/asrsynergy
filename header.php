...
<div class="row">
    ...
    <div class="col-6 pt-1 pb-1 text-center">
        <a href="<?php echo ROOT?>home"><img src="<?php echo ROOT?>images/logo.png" alt="" class="img-fluid"></a>
    </div>

    <div class="col-3 text-center text-md-right social-icon p-3 pl-0 pt-4 pr-4 pr-md-3">
        <div class="pt-md-2">
...
<div class="menu collapse" id="toggleMenu">
    <div class="menu-inner">
        <div class="row">
            ...
            <a href="#<?php echo ROOT?>products">Property</a>
            </div>            
            <div class="col-12 col-md p-2">
