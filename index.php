...
<body class="container-fluid p-0">
    ...
    <div class="row p-5" style="background:#EFEFEF; box-shadow: inset 0 0 4px rgba(0,0,0,.3)">
        <div class="col-12 col-md-10 offset-md-1 text-center">
            ...
            <div class="h2">
                ADVANCE SYNERGY REALTY SDN BHD (ASR) was incorporated in 1980 and its maiden project is TAMAN MATANG JAYA, which has evolved into a premier housing township of more than 3,000 households and also the most thriving commercial centre (SYNERGY SQUARE) in the Petra Jaya district.
            </div>
            <div class="p-4">
    ...
    <div class="my-container why_choose_us scroll_animate" ani-sub=".choose-block" style="border-top:1px solid #CCC; border-bottom:1px solid #CCC; background-color: #eeeeee; background-image:url('images/Endless-Constellation2.svg');  background-repeat: no-repeat; background-size:cover;">
        <div class="row"><div class="col-12"><br><br></div></div>
        <div class="row"><div class="col-12 d-none d-md-inline"><br><br></div></div>
        <div class="row">
            <div class="col-10 offset-1 text-center">
                <div class="h1"><span style="color:white;">WHY CHOOSE US</span></div>
                <div class="h2 pb-4" style="color:white;">Synergy home not just home, it's a living sanctuary</div>
                <div class="row">
                    <div class="col-12">
                        <div class="row">
                            <?php 
